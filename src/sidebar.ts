...
class PinVaultProSidebar {
    ...
    async checkPinterestStatus() {
        try {
            ...
            if (statusText) statusText.textContent = '连接检查失败，请重试';
        }
    }
